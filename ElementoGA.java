...
public class ElementoGA implements Comparable {
    ...
    public double calculo_distribuicao_turma_A() {
        ...
        float pa = (float) getPerfilA_turma_A() / 25; // Perfil de A na turma A
        float pb = (float) getPerfilB_turma_A() / 25; // Perfil de B na turma A
        float pc = (float) getPerfilC_turma_A() / 25; // Perfil de C na turma A
        float pd = (float) getPerfilD_turma_A() / 25; // Perfil de D na turma A
        float pe = (float) getPerfilE_turma_A() / 25; // Perfil de E na turma A
    ...
    public double calculo_distribuicao_turma_B() {
        ...
        float pa = (float) getPerfilA_turma_B() / 25; // Perfil de A na turma A
        float pb = (float) getPerfilB_turma_B() / 25; // Perfil de B na turma A
        float pc = (float) getPerfilC_turma_B() / 25; // Perfil de C na turma A
        float pd = (float) getPerfilD_turma_B() / 25; // Perfil de D na turma A
        float pe = (float) getPerfilE_turma_B() / 25; // Perfil de E na turma A
    ...
    public double calculo_distribuicao_turma_C() {
        ...
        float pa = (float) getPerfilA_turma_C() / 25; // Perfil de A na turma A
        float pb = (float) getPerfilB_turma_C() / 25; // Perfil de B na turma A
        float pc = (float) getPerfilC_turma_C() / 25; // Perfil de C na turma A
        float pd = (float) getPerfilD_turma_C() / 25; // Perfil de D na turma A
        float pe = (float) getPerfilE_turma_C() / 25; // Perfil de E na turma A
    ...
    public double calculo_distribuicao_turma_D() {
        ...
        float pa = (float) getPerfilA_turma_D() / 25; // Perfil de A na turma A
        float pb = (float) getPerfilB_turma_D() / 25; // Perfil de B na turma A
        float pc = (float) getPerfilC_turma_D() / 25; // Perfil de C na turma A
        float pd = (float) getPerfilD_turma_D() / 25; // Perfil de D na turma A
        float pe = (float) getPerfilE_turma_D() / 25; // Perfil de E na turma A
	...
	/*Esta fun��o deve ser sobreescrita por uma fun��o dentro da sub-classe
	  a ser usada como definidora dos cromossomos do GA*/
           ...
           this.avaliacao = (distTurma_A + distTurma_B + distTurma_C + distTurma_D) - 1;
	...
	public void trocar(int ind1, int ind2){
            ...
            //System.out.println("Ocorreu uma mutação ...");
        }
